...
import { Crumb, MissionStat, PageTitle } from "../common";
          ...
          {Object.entries(grouped).map(([level, items]) => (
            <section key={level} className="level-block">
              ...
              <div className="mission-grid">
                {items.map((mission) => (
                  <button key={mission.id} className="mission-card" type="button" onClick={() => openMission(mission.id)}>
